...
path('login/', auth_views.LoginView.as_view(template_name='recetas/login.html', authentication_form=LoginForm), name='login'),    path('logout/', auth_views.LogoutView.as_view(next_page='home'), name='logout'),
